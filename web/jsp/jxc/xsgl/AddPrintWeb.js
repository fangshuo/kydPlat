...
function forward(bj,djlx,object)
{
	...
	if(djlx == '001')//销售单
	{
		...
		url ='XiaoShowDanPrint!PrintData.action?data=';
	...
	{
		url ='FaHuoDanPrint!PrintData.action?data=';
	...
	{
		url ='TFHDanPrint!PrintData.action?data=';
		record.set('jhdh', 	object.jhdh);
