...
function print()
{
	...
	LODOP.PRINT_INIT("订货单套打");//打印初始化  
	LODOP.SET_PRINT_PAGESIZE("0","210mm","279mm","订货单套打")//设定纸张大小 为	A4
	...
	LODOP.ADD_PRINT_TEXT(160,200,150,30,Ext.getDom('sl').value);//数量
	LODOP.SET_PRINT_STYLEA(0,"FontSize",13);LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
	
	LODOP.ADD_PRINT_TEXT(160,350,150,30,Ext.getDom('dj').value);//单价
	LODOP.SET_PRINT_STYLEA(0,"FontSize",13);LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
	
	LODOP.ADD_PRINT_TEXT(160,500,150,30,Ext.getDom('je').value);//金额
	LODOP.SET_PRINT_STYLEA(0,"FontSize",13);LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
	
	LODOP.ADD_PRINT_TEXT(160,650,150,30,Ext.getDom('bz').value);//备注
	LODOP.SET_PRINT_STYLEA(0,"FontSize",13);LODOP.SET_PRINT_STYLEA(0,"Alignment",2);
