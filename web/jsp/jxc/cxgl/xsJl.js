Ext.onReady(function(){
	 ...
	 */
	 var form = new Ext.form.FormPanel({
    	...
    	submit: function() {   
			...
			form.getForm().getEl().dom.action='xsJlQuery!dcExcel.action'; 
     ...
     var splbRecord = Ext.data.Record.create([
        ...
        {name: 'thdh' 		,mapping:'thdh'		,type: 'string'},
        ...
        {name: 'thsl'	    ,mapping:'thsl'       ,type: 'float'},
        {name: 'sjsl'	    ,mapping:'sjsl'       ,type: 'float'},
        {name: 'sjje'	    ,mapping:'sjje'       ,type: 'float'},
    ...
    var store = new Ext.data.Store({
        proxy: new Ext.data.HttpProxy
        					({url:'xsJlQuery!queryData.action',
